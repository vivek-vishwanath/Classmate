...
data class User(val firstName: String, val lastName: String, val email: String, val school: String, val grade: Int, val contacts: ArrayList<String>, val courses: ArrayList<Course>) {

    constructor(firstName: String, lastName: String, email: String, school: String, grade: Int):
            this(firstName, lastName, email, school, grade, ArrayList(), ArrayList())
    ...
    companion object {
        ...
        fun from(map: Map<String, Any>) = object {
            ...
            val data = User(firstName, lastName, email, school, grade, contacts, courses)
        }.data
    }
